...
cat artifact_registry_credentials.json | docker login -u _json_key --password-stdin https://europe-west1-docker.pkg.dev

REGISTRY_NAME=europe-west1-docker.pkg.dev/lux-immo-438316/docker-images
APP_NAME=athome-scraper

# Install the binfmt support for building multi-platform images
